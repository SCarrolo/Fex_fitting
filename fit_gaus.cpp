...
int main (void)
{
  ...
  string a;
  cin >> a;
  cout << "o nome que inseriu é: " << a << ".txt" << endl;
  string titulograf ="LiF";
  string xtitulo = "n #lambda";
  string ytitulo = "2Sin(#theta)";

  TF1 *fitfunction = new TF1("fitting function", "gaus");


  int n=0;
  vector<double*> FileShit = ReadFileGeneral(a+".txt",n);
